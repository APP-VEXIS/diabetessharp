      ...
      <div className="relative w-full max-w-[380px] animate-in-up">
        ...
        <div className="flex flex-col items-center mb-10">
          <Link to="/home" className="group flex flex-col items-center gap-3">
            ...
            >
              <img src="/neurosharp-logo.png" alt="" className="w-8 h-8 object-contain" aria-hidden />
            </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
          ...
          <div className="space-y-1.5">
            <label htmlFor="ns-email" className="form-label">Email</label>
            <input
              id="ns-email"
              type="email"
          ...
          <div className="space-y-1.5">
            <label htmlFor="ns-password" className="form-label">Password</label>
